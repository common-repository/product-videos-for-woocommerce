    ...
    <tr>
        <td width="50%">
            <div class="api-video-div">
                <h3 style="text-align: center;font-size: 26px;">Product Review Find & Import For Woocommerce</h3>
                <a href="https://wordpress.org/plugins/review-find-and-import-for-woocommerce/" target="_blank" class="btn-more-information button">More Information</a><br /><br />
                <img src="<?php echo $image_plugin_reviews; ?>" width="100%" height="auto" alt="">
                <iframe width="100%" height="400" src="https://www.youtube.com/embed/i7da2XLFFdQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <br /><br />
            </div>
        </td>
        <td width="50%">
