...
<?php
    ...
    if(isset($_POST['stop_updates'])) {
        ...
        if (!wp_verify_nonce($nonce_stop_updates, 'action_stop_updates')) {
            ...
            update_option('api_pv_automation_status', '');
        }
    }
    ...
    if(isset($_POST['create_automation'])) {
        ...
        if (!wp_verify_nonce($nonce_automation, 'action_automation')) {
            ...
            update_option('api_pv_automation_count', 0);
            update_option('api_pv_total_products_start', 0);
            update_option('api_pv_automation_status', 'queued');
    ...
    $automation_status = get_option('api_pv_automation_status');
                                    ...
                                    <td width="70%">
                                        <?php
                                            ...
                                            if ($automation_status !== '') {
                                                echo '<strong>Automation Status</strong> ' . esc_html(ucwords($automation_status)) . '<br />';
                                            }
                        ...
                        <tr>
                            <td width="25%">
                                <div class="api-update-div">
                                    ...
                                    <p><?php echo esc_html(ucwords($automation_status)); ?></p>
                                </div>
                            </td>
                            <td width="25%">
                                <div class="api-update-div">
