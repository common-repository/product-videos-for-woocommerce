...
if (!function_exists ('api_pv_dashboard')) {
	function api_pv_dashboard() {
	   add_menu_page('Product Videos for Woocommerce', 'Product Videos', 'manage_woocommerce', 'api-pv-dashboard', 'api_pv_dashboard_callback', 'dashicons-format-video', 101);
	}
...
if (!function_exists ('api_pv_other_plugins')) {
	function api_pv_other_plugins() {
	   add_submenu_page('api-pv-dashboard', 'Other Great Plugins', 'Other Plugins','manage_woocommerce', 'api-pv-other-plugins', 'api_pv_other_plugins_callback');
	}
