            	...
            	if ($count > 0) {
            		...
            		for ($i=0; $i < $count; $i++) {
                        ...
                        if (isset($items[$i]->{'title'})) {
                            ...
                            $video_title_lower_case = str_replace("'", "", $video_title_lower_case);
                            $items[$i]->{'title'} = esc_attr($video_title);
                        } else {
                            $video_title = '';
                            $video_title_lower_case = 'none';
                        }
                        ...
                        if ($video_url == '') {
                            ...
                            // if sku is required in the video title
                                ...
                                // $brand_lower_case = preg_replace('/[^\w]/', '', $brand_lower_case);
                                // $brand_lower_case = str_replace(array('\'', '"'), '', $brand_lower_case);
                                $brand_text = ucwords($brand_lower_case);
                                if (strpos($video_title_lower_case, $brand_lower_case) !== false && $video_title_lower_case !== 'none') {
                                    ...
                                    $bad_url = $video_url;
                                    $video_url = '';
                                    echo $video_title_lower_case . ' - ' . $brand_lower_case . '<br />';
                                }
